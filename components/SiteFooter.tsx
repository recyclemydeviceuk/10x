...
const socials = [
  ...
  { label: 'Facebook', href: 'https://www.facebook.com/10xdrink', d: 'M22 12.06C22 6.5 17.52 2 12 2S2 6.5 2 12.06c0 5 3.66 9.13 8.44 9.94v-7.03H7.9v-2.91h2.54V9.85c0-2.51 1.49-3.89 3.77-3.89 1.09 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56v1.88h2.78l-.44 2.91h-2.34V22c4.78-.81 8.44-4.94 8.44-9.94Z' },
  { label: 'Twitter', href: 'https://twitter.com/10xdrink', d: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231 5.45-6.231Zm-1.161 17.52h1.833L7.084 4.126H5.117l11.966 15.644Z' },
  ...
  { label: 'YouTube', href: 'https://www.youtube.com/@10xdrink', d: 'M23.5 6.2a3.02 3.02 0 0 0-2.13-2.13C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.37.57A3.02 3.02 0 0 0 .5 6.2C0 8.07 0 12 0 12s0 3.93.5 5.8a3.02 3.02 0 0 0 2.13 2.13C4.5 20.5 12 20.5 12 20.5s7.5 0 9.37-.57a3.02 3.02 0 0 0 2.13-2.13c.5-1.87.5-5.8.5-5.8s0-3.93-.5-5.8ZM9.6 15.6V8.4l6.24 3.6-6.24 3.6Z' },
];

const collectionLinks = [
  { label: 'Shop 10X Daytime', href: '/products/10x-daytime' },
  { label: 'The Science', href: '/science' },
  { label: 'Formulation', href: '/formulation' },
  { label: 'Available At', href: '/#available-at' },
];
        ...
        <div className="mx-auto max-w-7xl px-6 py-14 sm:px-10 md:px-14 md:py-20">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-12 md:gap-8">
            ...
            <nav aria-label="Shop" className="md:col-span-2">
              <p className="mb-4 font-quantico text-caption font-bold uppercase tracking-[0.16em] text-white/50">Shop</p>
            ...
            <nav aria-label="Company" className="md:col-span-3">
              <p className="mb-4 font-quantico text-caption font-bold uppercase tracking-[0.16em] text-white/50">Company</p>
              <ul className="space-y-4 font-pt text-body">
                {supportLinks.map((l) => (
                  <li key={l.label}>
                    <Link href={l.href} className="cursor-pointer transition-opacity hover:opacity-80">
        ...
        <div className="border-t border-white/15">
          <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-6 sm:px-10 md:flex-row md:items-center md:justify-between md:px-14">
            <p className="font-pt text-body-sm text-white/80">
              © 2026 10X Formulas. All rights reserved.
            </p>
