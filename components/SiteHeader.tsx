...
export default function SiteHeader() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 sm:px-10 md:h-[72px] md:px-14">
        ...
        <Link
          href={PRODUCT_HREF}
          className="inline-flex cursor-pointer items-center gap-2 bg-accent px-6 py-2.5 font-quantico text-caption font-bold uppercase tracking-[0.16em] text-ink transition-colors hover:bg-accent-hover md:px-8 md:py-3 md:text-body-sm"
        >
          Order Now
