...
export default function LoginForm() {
  ...
  if (step === 'success') {
    return (
      <AuthSuccessCard title="You're in" subtitle="Welcome to 10X. Redirecting…" />
    );
  }
  ...
  return (
    <form onSubmit={handleSendOtp} className="space-y-5" noValidate>
      ...
      <button
        type="submit"
        disabled={sending}
        className="w-full cursor-pointer px-6 py-3.5 font-quantico text-body-sm font-bold uppercase tracking-[0.18em] text-white shadow-elevated transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
        style={authButtonStyle}
      >
