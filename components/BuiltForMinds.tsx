    ...
    <section aria-label="Built for high-output minds" className="bg-paper-100 py-20 md:py-24">
      <div className="mx-auto max-w-7xl px-6 sm:px-10 md:px-14">
        <div className="flex items-end justify-between gap-4">
          <div>
            <h2 className="font-condensed uppercase text-ink dark:text-white">
          ...
          <div className="hidden shrink-0 gap-2 sm:flex">
            <button
              ...
              className="flex h-10 w-10 cursor-pointer items-center justify-center border border-paper-300 bg-white dark:bg-paper text-ink dark:text-white transition-colors hover:border-fg"
            >
