  ...
  return (
    <main id="main" className="bg-paper">
      ...
      <section
        ...
        style={{ background: 'radial-gradient(120% 90% at 50% 0%, #0821D2 0%, #02063A 55%, #000204 100%)' }}
      >
        ...
        <div className="mx-auto max-w-6xl px-6 py-20 sm:px-10 md:px-14 md:py-28">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3 md:gap-8">
            {blend.map(({ title, body, Icon }, i) => (
              <div key={title} className="group relative overflow-hidden border border-paper-200 bg-white p-8 transition-colors hover:border-brand-blue md:p-10">
                <span aria-hidden className="absolute -right-1 top-0 font-condensed text-[6rem] font-black italic leading-none text-paper-100">
                  0{i + 1}
                </span>
                <span className="relative flex h-16 w-16 items-center justify-center border-2 border-brand-blue text-brand-blue">
