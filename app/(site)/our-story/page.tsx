...
export default function OurStoryPage() {
  return (
    <main id="main" className="bg-paper">
      ...
      {/* ============ Stats strip ============ */}
      <section className="border-b border-paper-200 bg-white dark:bg-paper">
        <div className="mx-auto max-w-6xl px-6 sm:px-10 md:px-14">
          <div className="grid grid-cols-2 gap-px bg-paper-200 md:grid-cols-4">
            {stats.map(({ value, label, Icon }) => (
              <div key={label} className="flex flex-col items-center bg-white dark:bg-paper px-4 py-12 text-center md:px-6 md:py-16">
                <span className="flex h-14 w-14 items-center justify-center border border-paper-300 text-accent">
      ...
      <section className="bg-paper">
        <div className="mx-auto max-w-6xl px-6 py-20 sm:px-10 md:px-14 md:py-28">
          ...
          <div className="mt-14 grid items-stretch gap-6 md:grid-cols-[1fr_auto_1fr] md:gap-4">
            <div className="flex flex-col border border-paper-200 bg-white dark:bg-paper p-8 shadow-card dark:shadow-none md:p-10">
            ...
            <div className="flex items-center justify-center text-accent md:px-2">
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-6 py-20 sm:px-10 md:grid-cols-2 md:gap-16 md:px-14 md:py-28">
          <div className="relative">
            <div className="relative aspect-[4/5] w-full overflow-hidden bg-paper-200">
              <ThemedProductImage src={PRODUCT_IMAGES.elevated} alt="10X in everyday use" fill sizes="(min-width: 768px) 50vw, 100vw" className="object-cover" />
            </div>
          ...
          <div>
            ...
            {/* pull quote */}
            <figure className="mt-8 border-l-4 border-accent bg-white dark:bg-paper py-5 pl-6 pr-5 shadow-card dark:shadow-none">
              ...
              <figcaption className="mt-2 font-quantico text-caption font-bold uppercase tracking-widest text-accent">
                The 10X Principle
              </figcaption>
            </figure>
          </div>
      ...
      <section className="bg-paper">
        <div className="mx-auto max-w-6xl px-6 py-20 sm:px-10 md:px-14 md:py-28">
          <div className="grid gap-6 md:grid-cols-2 md:gap-8">
            <div className="flex items-start gap-5 border border-paper-200 bg-white dark:bg-paper p-8">
            ...
            <div className="flex items-start gap-5 border-2 border-accent bg-white dark:bg-paper p-8 shadow-card dark:shadow-none">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20 sm:px-10 md:px-14 md:py-28">
          ...
          <div className="mt-14 grid gap-px overflow-hidden border border-white/15 bg-white/15 md:grid-cols-3">
            {beliefs.map(({ label, body, Icon }) => (
              <div key={label} className="bg-ink p-8 md:p-10">
                <span className="flex h-14 w-14 items-center justify-center border-2 border-accent text-accent">
                  <Icon className="h-7 w-7" />
                </span>
